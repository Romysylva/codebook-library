...
export const Checkout = ({ setCheckout }) => {
    ...
    async function handleOrderSubmit(event) {
        ...
        try {
            ...
            toast.error(error.message, { closeButton: true, position: "bottom-center", closeOnClick: true })
            navigate("/order-summary", { state: { error: "Oops! an Error Occoured", status: false } });
                        ...
                        <div className="py-6 px-6 lg:px-8">
                            ...
                            <form onClick={handleOrderSubmit} className="space-y-6" >
                                ...
                                <div>
                                    ...
                                    <input type="text" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:value-gray-400 dark:text-white" value={user.email || " example.mail"} disabled required="" />
                                </div>
                                <div>
